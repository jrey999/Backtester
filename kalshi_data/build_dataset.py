...
football game (Sept 3, 2026) and writes:
  - kalshi_data/siu_samford_raw.json                (full raw API responses)
  - kalshi_data/siu_samford_trades.csv               (every individual trade)
  - kalshi_data/siu_samford_hourly_price_history.csv (hourly OHLC candlesticks)
